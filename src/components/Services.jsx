...
const Services = () => {
  return (
    <div className='flex flex-col min-h-[60vh] gap-3 p-5 '>
        ...
        className='p-3  flex gap-2 w-full justify-evenly flex-col md:flex-row items-center border-black  '>
            <div className='p-3 md:w-[35rem]'>
                <h1 className='fontnormal md:text-4xl my-4 text-[#445eea] text-2xl'>What I will Provide You ?</h1>
            ...
            <img className='p-3 md:w-[38rem] w-[23rem]' src='https://cdni.iconscout.com/illustration/premium/thumb/developer-4268348-3560991.png?f=webp' alt="img" />
        </motion.div>
        ...
        <img className='p-3 w-[24rem] ' src='https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRCMipynwFp_x6lTsvFwCEi_eIMA9BGD0jOu4jQbaF0Ew&s' alt="img" />
            
            <div className='p-3 md:w-[35rem]'>
                <h1 className='fontnormal md:text-4xl my-4 text-[#445eea] text-2xl'>Expertise in building React-based applications.</h1>
